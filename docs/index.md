# Igloo MCP Documentation

This index groups the existing guides so new users and contributors can find the right entrypoint quickly.

## Core Usage

- Getting started: `docs/getting-started.md`
- Installation & editor setup: `docs/installation.md`
